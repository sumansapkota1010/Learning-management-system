...
function CourseCard({ course }: { course: ICourse }) {
  return (
    <div className="p-10 flex  items-center">
      <div className="max-w-xs bg-white rounded-xl overflow-hidden shadow-lg border border-gray-100">
        ...
        <div className="bg-cyan-50 text-cyan-700 px-4 py-1 text-xs font-semibold flex items-center gap-2">
          ...
          <span>LEVEL TEXT HERE</span>
        </div>
        <div className="p-4">
          <p className="text-xs text-gray-500 mb-1">Category Text</p>
          <h3 className="text-base font-semibold text-gray-800 mb-3 leading-tight">
            Course Title Here - Example of a Longer Title Needing Space
          </h3>
          ...
          <div className="flex items-center gap-3">
            <button className="flex-1 px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
              More Info
            </button>
            <button className="flex-1 px-4 py-2 bg-emerald-500 text-white rounded-lg text-sm font-medium hover:bg-emerald-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500">
              Start Learning
            </button>
          </div>
        </div>
